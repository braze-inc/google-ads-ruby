      ...
      module Factories
        module V7
          module Operations
            ...
            #
            # @return [Google::Ads::GoogleAds::V7::Common::TargetRestrictionOperation] the operation
            def self.target_restriction
              require "google/ads/google_ads/v7/common/targeting_setting_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Common::TargetRestrictionOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Common::TargetRestrictionOperation.new
              end
            end

            # Create a new FeedAttributeOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Resources::FeedAttributeOperation] the operation
            def self.feed_attribute
              require "google/ads/google_ads/v7/resources/feed_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Resources::FeedAttributeOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Resources::FeedAttributeOperation.new
              end
            end

            # Create a new AdGroupAssetOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::AdGroupAssetOperation] the operation
            def self.ad_group_asset
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::AdGroupAssetOperation.new
              end
            end

            # Create a new LabelOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::LabelOperation] the operation
            def self.label
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::LabelOperation.new
              end
            end

            # Create a new CampaignBudgetOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CampaignBudgetOperation] the operation
            def self.campaign_budget
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::CampaignBudgetOperation.new
              end
            end

            # Create a new CustomerUserAccessOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CustomerUserAccessOperation] the operation
            def self.customer_user_access
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::CustomerUserAccessOperation.new
              end
            end

            # Create a new FeedItemSetOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::FeedItemSetOperation] the operation
            def self.feed_item_set
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::FeedItemSetOperation.new
              end
            end

            # Create a new CampaignLabelOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CampaignLabelOperation] the operation
            def self.campaign_label
              require "google/ads/google_ads/v7/services/campaign_label_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::CampaignLabelOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::CampaignLabelOperation.new
              end
            end

            # Create a new CampaignOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CampaignOperation] the operation
            def self.campaign
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::CampaignOperation.new
              end
            end

            # Create a new AdGroupCriterionLabelOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::AdGroupCriterionLabelOperation] the operation
            def self.ad_group_criterion_label
              require "google/ads/google_ads/v7/services/ad_group_criterion_label_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::AdGroupCriterionLabelOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::AdGroupCriterionLabelOperation.new
              end
            end

            # Create a new AdGroupExtensionSettingOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::AdGroupExtensionSettingOperation] the operation
            def self.ad_group_extension_setting
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::AdGroupExtensionSettingOperation.new
              end
            end

            # Create a new AdGroupAdLabelOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::AdGroupAdLabelOperation] the operation
            def self.ad_group_ad_label
              require "google/ads/google_ads/v7/services/ad_group_ad_label_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::AdGroupAdLabelOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::AdGroupAdLabelOperation.new
              end
            end

            # Create a new ConversionActionOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::ConversionActionOperation] the operation
            def self.conversion_action
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::ConversionActionOperation.new
              end
            end

            # Create a new CampaignFeedOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CampaignFeedOperation] the operation
            def self.campaign_feed
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::CampaignFeedOperation.new
              end
            end

            # Create a new KeywordPlanCampaignOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::KeywordPlanCampaignOperation] the operation
            def self.keyword_plan_campaign
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::KeywordPlanCampaignOperation.new
              end
            end

            # Create a new CustomerUserAccessInvitationOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CustomerUserAccessInvitationOperation] the operation
            def self.customer_user_access_invitation
              ...
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::CustomerUserAccessInvitationOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::CustomerUserAccessInvitationOperation.new
              end
            end

            # Create a new FeedOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::FeedOperation] the operation
            def self.feed
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::FeedOperation.new
              end
            end

            # Create a new KeywordPlanAdGroupOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::KeywordPlanAdGroupOperation] the operation
            def self.keyword_plan_ad_group
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::KeywordPlanAdGroupOperation.new
              end
            end

            # Create a new KeywordPlanOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::KeywordPlanOperation] the operation
            def self.keyword_plan
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::KeywordPlanOperation.new
              end
            end

            # Create a new AccountLinkOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::AccountLinkOperation] the operation
            def self.account_link
              require "google/ads/google_ads/v7/services/account_link_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::AccountLinkOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::AccountLinkOperation.new
              end
            end

            # Create a new CampaignSharedSetOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CampaignSharedSetOperation] the operation
            def self.campaign_shared_set
              require "google/ads/google_ads/v7/services/campaign_shared_set_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::CampaignSharedSetOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::CampaignSharedSetOperation.new
              end
            end

            # Create a new FeedItemTargetOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::FeedItemTargetOperation] the operation
            def self.feed_item_target
              require "google/ads/google_ads/v7/services/feed_item_target_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::FeedItemTargetOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::FeedItemTargetOperation.new
              end
            end

            # Create a new CampaignAssetOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CampaignAssetOperation] the operation
            def self.campaign_asset
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::CampaignAssetOperation.new
              end
            end

            # Create a new SharedSetOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::SharedSetOperation] the operation
            def self.shared_set
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::SharedSetOperation.new
              end
            end

            # Create a new BillingSetupOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::BillingSetupOperation] the operation
            def self.billing_setup
              require "google/ads/google_ads/v7/services/billing_setup_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::BillingSetupOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::BillingSetupOperation.new
              end
            end

            # Create a new MerchantCenterLinkOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::MerchantCenterLinkOperation] the operation
            def self.merchant_center_link
              require "google/ads/google_ads/v7/services/merchant_center_link_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::MerchantCenterLinkOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::MerchantCenterLinkOperation.new
              end
            end

            # Create a new CampaignExtensionSettingOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CampaignExtensionSettingOperation] the operation
            def self.campaign_extension_setting
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::CampaignExtensionSettingOperation.new
              end
            end

            # Create a new AdGroupOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::AdGroupOperation] the operation
            def self.ad_group
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::AdGroupOperation.new
              end
            end

            # Create a new SharedCriterionOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::SharedCriterionOperation] the operation
            def self.shared_criterion
              require "google/ads/google_ads/v7/services/shared_criterion_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::SharedCriterionOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::SharedCriterionOperation.new
              end
            end

            # Create a new CustomerManagerLinkOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CustomerManagerLinkOperation] the operation
            def self.customer_manager_link
              require "google/ads/google_ads/v7/services/customer_manager_link_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::CustomerManagerLinkOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::CustomerManagerLinkOperation.new
              end
            end

            # Create a new FeedItemSetLinkOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::FeedItemSetLinkOperation] the operation
            def self.feed_item_set_link
              require "google/ads/google_ads/v7/services/feed_item_set_link_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::FeedItemSetLinkOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::FeedItemSetLinkOperation.new
              end
            end

            # Create a new AccountBudgetProposalOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::AccountBudgetProposalOperation] the operation
            def self.account_budget_proposal
              require "google/ads/google_ads/v7/services/account_budget_proposal_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::AccountBudgetProposalOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::AccountBudgetProposalOperation.new
              end
            end

            # Create a new AssetOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::AssetOperation] the operation
            def self.asset
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::AssetOperation.new
              end
            end

            # Create a new AdGroupAdOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::AdGroupAdOperation] the operation
            def self.ad_group_ad
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::AdGroupAdOperation.new
              end
            end

            # Create a new AdGroupBidModifierOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::AdGroupBidModifierOperation] the operation
            def self.ad_group_bid_modifier
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::AdGroupBidModifierOperation.new
              end
            end

            # Create a new AdGroupCriterionOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::AdGroupCriterionOperation] the operation
            def self.ad_group_criterion
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::AdGroupCriterionOperation.new
              end
            end

            # Create a new AdGroupFeedOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::AdGroupFeedOperation] the operation
            def self.ad_group_feed
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::AdGroupFeedOperation.new
              end
            end

            # Create a new AdGroupLabelOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::AdGroupLabelOperation] the operation
            def self.ad_group_label
              require "google/ads/google_ads/v7/services/ad_group_label_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::AdGroupLabelOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::AdGroupLabelOperation.new
              end
            end

            # Create a new AdParameterOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::AdParameterOperation] the operation
            def self.ad_parameter
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::AdParameterOperation.new
              end
            end

            # Create a new AdOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::AdOperation] the operation
            def self.ad
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::AdOperation.new
              end
            end

            # Create a new BiddingStrategyOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::BiddingStrategyOperation] the operation
            def self.bidding_strategy
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::BiddingStrategyOperation.new
              end
            end

            # Create a new CampaignBidModifierOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CampaignBidModifierOperation] the operation
            def self.campaign_bid_modifier
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::CampaignBidModifierOperation.new
              end
            end

            # Create a new CampaignCriterionOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CampaignCriterionOperation] the operation
            def self.campaign_criterion
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::CampaignCriterionOperation.new
              end
            end

            # Create a new CampaignDraftOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CampaignDraftOperation] the operation
            def self.campaign_draft
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::CampaignDraftOperation.new
              end
            end

            # Create a new CampaignExperimentOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CampaignExperimentOperation] the operation
            def self.campaign_experiment
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::CampaignExperimentOperation.new
              end
            end

            # Create a new ConversionCustomVariableOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::ConversionCustomVariableOperation] the operation
            def self.conversion_custom_variable
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::ConversionCustomVariableOperation.new
              end
            end

            # Create a new CustomerAssetOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CustomerAssetOperation] the operation
            def self.customer_asset
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::CustomerAssetOperation.new
              end
            end

            # Create a new CustomerExtensionSettingOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CustomerExtensionSettingOperation] the operation
            def self.customer_extension_setting
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::CustomerExtensionSettingOperation.new
              end
            end

            # Create a new CustomerFeedOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CustomerFeedOperation] the operation
            def self.customer_feed
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::CustomerFeedOperation.new
              end
            end

            # Create a new CustomerLabelOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CustomerLabelOperation] the operation
            def self.customer_label
              require "google/ads/google_ads/v7/services/customer_label_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::CustomerLabelOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::CustomerLabelOperation.new
              end
            end

            # Create a new CustomerNegativeCriterionOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CustomerNegativeCriterionOperation] the operation
            def self.customer_negative_criterion
              require "google/ads/google_ads/v7/services/customer_negative_criterion_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::CustomerNegativeCriterionOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::CustomerNegativeCriterionOperation.new
              end
            end

            # Create a new CustomerOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CustomerOperation] the operation
            def self.customer
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::CustomerOperation.new
              end
            end

            # Create a new ExtensionFeedItemOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::ExtensionFeedItemOperation] the operation
            def self.extension_feed_item
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::ExtensionFeedItemOperation.new
              end
            end

            # Create a new FeedItemOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::FeedItemOperation] the operation
            def self.feed_item
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::FeedItemOperation.new
              end
            end

            # Create a new FeedMappingOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::FeedMappingOperation] the operation
            def self.feed_mapping
              require "google/ads/google_ads/v7/services/feed_mapping_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::FeedMappingOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::FeedMappingOperation.new
              end
            end

            # Create a new KeywordPlanAdGroupKeywordOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::KeywordPlanAdGroupKeywordOperation] the operation
            def self.keyword_plan_ad_group_keyword
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::KeywordPlanAdGroupKeywordOperation.new
              end
            end

            # Create a new KeywordPlanCampaignKeywordOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::KeywordPlanCampaignKeywordOperation] the operation
            def self.keyword_plan_campaign_keyword
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::KeywordPlanCampaignKeywordOperation.new
              end
            end

            # Create a new MediaFileOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::MediaFileOperation] the operation
            def self.media_file
              require "google/ads/google_ads/v7/services/media_file_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::MediaFileOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::MediaFileOperation.new
              end
            end

            # Create a new RemarketingActionOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::RemarketingActionOperation] the operation
            def self.remarketing_action
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::RemarketingActionOperation.new
              end
            end

            # Create a new UserListOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::UserListOperation] the operation
            def self.user_list
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::UserListOperation.new
              end
            end

            # Create a new MutateOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::MutateOperation] the operation
            def self.mutate
              require "google/ads/google_ads/v7/services/google_ads_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::MutateOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::MutateOperation.new
              end
            end

            # Create a new BatchJobOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::BatchJobOperation] the operation
            def self.batch_job
              require "google/ads/google_ads/v7/services/batch_job_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::BatchJobOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::BatchJobOperation.new
              end
            end

            # Create a new OfflineUserDataJobOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::OfflineUserDataJobOperation] the operation
            def self.offline_user_data_job
              require "google/ads/google_ads/v7/services/offline_user_data_job_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::OfflineUserDataJobOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::OfflineUserDataJobOperation.new
              end
            end

            # Create a new CustomInterestOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CustomInterestOperation] the operation
            def self.custom_interest
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::CustomInterestOperation.new
              end
            end

            # Create a new ApplyRecommendationOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::ApplyRecommendationOperation] the operation
            def self.apply_recommendation
              require "google/ads/google_ads/v7/services/recommendation_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::ApplyRecommendationOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::ApplyRecommendationOperation.new
              end
            end

            # Create a new DismissRecommendationOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::DismissRecommendationRequest::DismissRecommendationOperation] the operation
            def self.dismiss_recommendation
              require "google/ads/google_ads/v7/services/recommendation_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::DismissRecommendationRequest::DismissRecommendationOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::DismissRecommendationRequest::DismissRecommendationOperation.new
              end
            end

            # Create a new UserDataOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::UserDataOperation] the operation
            def self.user_data
              require "google/ads/google_ads/v7/services/user_data_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::UserDataOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::UserDataOperation.new
              end
            end

            # Create a new CustomerClientLinkOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CustomerClientLinkOperation] the operation
            def self.customer_client_link
              require "google/ads/google_ads/v7/services/customer_client_link_service_pb"
              if block_given?
                op = Google::Ads::GoogleAds::V7::Services::CustomerClientLinkOperation.new
                yield op
                op
              else
                Google::Ads::GoogleAds::V7::Services::CustomerClientLinkOperation.new
              end
            end

            # Create a new CustomAudienceOperation
            #
            # @return [Google::Ads::GoogleAds::V7::Services::CustomAudienceOperation] the operation
            def self.custom_audience
              ...
              if block_given?
                ...
                Google::Ads::GoogleAds::V7::Services::CustomAudienceOperation.new
              end
            end
            ...
            # resources
            #
            # @return [Google::Ads::GoogleAds::Factories::V7::Operations::CreateResource]
            ...
            # resources
            #
            # @return [Google::Ads::GoogleAds::Factories::V7::Operations::UpdateResource]
            ...
            # resources
            #
            # @return [Google::Ads::GoogleAds::Factories::V7::Operations::RemoveResource]
            ...
            module CreateResource
              ...
              #   @param res [Google::Ads::GoogleAds::V7::Resources::AdGroupAsset]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::AdGroupAssetOperation] instance that will create the resource
              def self.ad_group_asset(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.ad_group_asset(&blk)
                else
                  Factories::V7::Resources.ad_group_asset
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::Label]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::LabelOperation] instance that will create the resource
              def self.label(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.label(&blk)
                else
                  Factories::V7::Resources.label
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CampaignBudget]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CampaignBudgetOperation] instance that will create the resource
              def self.campaign_budget(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.campaign_budget(&blk)
                else
                  Factories::V7::Resources.campaign_budget
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::FeedItemSet]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::FeedItemSetOperation] instance that will create the resource
              def self.feed_item_set(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.feed_item_set(&blk)
                else
                  Factories::V7::Resources.feed_item_set
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CampaignLabel]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CampaignLabelOperation] instance that will create the resource
              def self.campaign_label(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.campaign_label(&blk)
                else
                  Factories::V7::Resources.campaign_label
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::Campaign]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CampaignOperation] instance that will create the resource
              def self.campaign(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.campaign(&blk)
                else
                  Factories::V7::Resources.campaign
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::AdGroupCriterionLabel]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::AdGroupCriterionLabelOperation] instance that will create the resource
              def self.ad_group_criterion_label(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.ad_group_criterion_label(&blk)
                else
                  Factories::V7::Resources.ad_group_criterion_label
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::AdGroupExtensionSetting]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::AdGroupExtensionSettingOperation] instance that will create the resource
              def self.ad_group_extension_setting(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.ad_group_extension_setting(&blk)
                else
                  Factories::V7::Resources.ad_group_extension_setting
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::AdGroupAdLabel]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::AdGroupAdLabelOperation] instance that will create the resource
              def self.ad_group_ad_label(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.ad_group_ad_label(&blk)
                else
                  Factories::V7::Resources.ad_group_ad_label
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::ConversionAction]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::ConversionActionOperation] instance that will create the resource
              def self.conversion_action(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.conversion_action(&blk)
                else
                  Factories::V7::Resources.conversion_action
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CampaignFeed]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CampaignFeedOperation] instance that will create the resource
              def self.campaign_feed(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.campaign_feed(&blk)
                else
                  Factories::V7::Resources.campaign_feed
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::KeywordPlanCampaign]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::KeywordPlanCampaignOperation] instance that will create the resource
              def self.keyword_plan_campaign(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.keyword_plan_campaign(&blk)
                else
                  Factories::V7::Resources.keyword_plan_campaign
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CustomerUserAccessInvitation]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CustomerUserAccessInvitationOperation] instance that will create the resource
              def self.customer_user_access_invitation(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.customer_user_access_invitation(&blk)
                else
                  Factories::V7::Resources.customer_user_access_invitation
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::Feed]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::FeedOperation] instance that will create the resource
              def self.feed(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.feed(&blk)
                else
                  Factories::V7::Resources.feed
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::KeywordPlanAdGroup]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::KeywordPlanAdGroupOperation] instance that will create the resource
              def self.keyword_plan_ad_group(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.keyword_plan_ad_group(&blk)
                else
                  Factories::V7::Resources.keyword_plan_ad_group
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::KeywordPlan]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::KeywordPlanOperation] instance that will create the resource
              def self.keyword_plan(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.keyword_plan(&blk)
                else
                  Factories::V7::Resources.keyword_plan
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CampaignSharedSet]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CampaignSharedSetOperation] instance that will create the resource
              def self.campaign_shared_set(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.campaign_shared_set(&blk)
                else
                  Factories::V7::Resources.campaign_shared_set
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::FeedItemTarget]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::FeedItemTargetOperation] instance that will create the resource
              def self.feed_item_target(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.feed_item_target(&blk)
                else
                  Factories::V7::Resources.feed_item_target
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CampaignAsset]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CampaignAssetOperation] instance that will create the resource
              def self.campaign_asset(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.campaign_asset(&blk)
                else
                  Factories::V7::Resources.campaign_asset
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::SharedSet]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::SharedSetOperation] instance that will create the resource
              def self.shared_set(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.shared_set(&blk)
                else
                  Factories::V7::Resources.shared_set
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::BillingSetup]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::BillingSetupOperation] instance that will create the resource
              def self.billing_setup(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.billing_setup(&blk)
                else
                  Factories::V7::Resources.billing_setup
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CampaignExtensionSetting]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CampaignExtensionSettingOperation] instance that will create the resource
              def self.campaign_extension_setting(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.campaign_extension_setting(&blk)
                else
                  Factories::V7::Resources.campaign_extension_setting
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::AdGroup]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::AdGroupOperation] instance that will create the resource
              def self.ad_group(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.ad_group(&blk)
                else
                  Factories::V7::Resources.ad_group
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::SharedCriterion]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::SharedCriterionOperation] instance that will create the resource
              def self.shared_criterion(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.shared_criterion(&blk)
                else
                  Factories::V7::Resources.shared_criterion
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::FeedItemSetLink]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::FeedItemSetLinkOperation] instance that will create the resource
              def self.feed_item_set_link(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.feed_item_set_link(&blk)
                else
                  Factories::V7::Resources.feed_item_set_link
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::AccountBudgetProposal]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::AccountBudgetProposalOperation] instance that will create the resource
              def self.account_budget_proposal(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.account_budget_proposal(&blk)
                else
                  Factories::V7::Resources.account_budget_proposal
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::Asset]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::AssetOperation] instance that will create the resource
              def self.asset(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.asset(&blk)
                else
                  Factories::V7::Resources.asset
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::AdGroupAd]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::AdGroupAdOperation] instance that will create the resource
              def self.ad_group_ad(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.ad_group_ad(&blk)
                else
                  Factories::V7::Resources.ad_group_ad
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::AdGroupBidModifier]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::AdGroupBidModifierOperation] instance that will create the resource
              def self.ad_group_bid_modifier(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.ad_group_bid_modifier(&blk)
                else
                  Factories::V7::Resources.ad_group_bid_modifier
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::AdGroupCriterion]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::AdGroupCriterionOperation] instance that will create the resource
              def self.ad_group_criterion(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.ad_group_criterion(&blk)
                else
                  Factories::V7::Resources.ad_group_criterion
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::AdGroupFeed]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::AdGroupFeedOperation] instance that will create the resource
              def self.ad_group_feed(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.ad_group_feed(&blk)
                else
                  Factories::V7::Resources.ad_group_feed
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::AdGroupLabel]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::AdGroupLabelOperation] instance that will create the resource
              def self.ad_group_label(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.ad_group_label(&blk)
                else
                  Factories::V7::Resources.ad_group_label
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::AdParameter]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::AdParameterOperation] instance that will create the resource
              def self.ad_parameter(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.ad_parameter(&blk)
                else
                  Factories::V7::Resources.ad_parameter
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::BiddingStrategy]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::BiddingStrategyOperation] instance that will create the resource
              def self.bidding_strategy(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.bidding_strategy(&blk)
                else
                  Factories::V7::Resources.bidding_strategy
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CampaignBidModifier]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CampaignBidModifierOperation] instance that will create the resource
              def self.campaign_bid_modifier(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.campaign_bid_modifier(&blk)
                else
                  Factories::V7::Resources.campaign_bid_modifier
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CampaignCriterion]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CampaignCriterionOperation] instance that will create the resource
              def self.campaign_criterion(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.campaign_criterion(&blk)
                else
                  Factories::V7::Resources.campaign_criterion
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CampaignDraft]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CampaignDraftOperation] instance that will create the resource
              def self.campaign_draft(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.campaign_draft(&blk)
                else
                  Factories::V7::Resources.campaign_draft
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::ConversionCustomVariable]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::ConversionCustomVariableOperation] instance that will create the resource
              def self.conversion_custom_variable(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.conversion_custom_variable(&blk)
                else
                  Factories::V7::Resources.conversion_custom_variable
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CustomerAsset]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CustomerAssetOperation] instance that will create the resource
              def self.customer_asset(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.customer_asset(&blk)
                else
                  Factories::V7::Resources.customer_asset
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CustomerExtensionSetting]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CustomerExtensionSettingOperation] instance that will create the resource
              def self.customer_extension_setting(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.customer_extension_setting(&blk)
                else
                  Factories::V7::Resources.customer_extension_setting
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CustomerFeed]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CustomerFeedOperation] instance that will create the resource
              def self.customer_feed(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.customer_feed(&blk)
                else
                  Factories::V7::Resources.customer_feed
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CustomerLabel]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CustomerLabelOperation] instance that will create the resource
              def self.customer_label(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.customer_label(&blk)
                else
                  Factories::V7::Resources.customer_label
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CustomerNegativeCriterion]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CustomerNegativeCriterionOperation] instance that will create the resource
              def self.customer_negative_criterion(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.customer_negative_criterion(&blk)
                else
                  Factories::V7::Resources.customer_negative_criterion
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::ExtensionFeedItem]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::ExtensionFeedItemOperation] instance that will create the resource
              def self.extension_feed_item(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.extension_feed_item(&blk)
                else
                  Factories::V7::Resources.extension_feed_item
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::FeedItem]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::FeedItemOperation] instance that will create the resource
              def self.feed_item(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.feed_item(&blk)
                else
                  Factories::V7::Resources.feed_item
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::FeedMapping]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::FeedMappingOperation] instance that will create the resource
              def self.feed_mapping(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.feed_mapping(&blk)
                else
                  Factories::V7::Resources.feed_mapping
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::KeywordPlanAdGroupKeyword]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::KeywordPlanAdGroupKeywordOperation] instance that will create the resource
              def self.keyword_plan_ad_group_keyword(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.keyword_plan_ad_group_keyword(&blk)
                else
                  Factories::V7::Resources.keyword_plan_ad_group_keyword
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::KeywordPlanCampaignKeyword]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::KeywordPlanCampaignKeywordOperation] instance that will create the resource
              def self.keyword_plan_campaign_keyword(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.keyword_plan_campaign_keyword(&blk)
                else
                  Factories::V7::Resources.keyword_plan_campaign_keyword
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::MediaFile]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::MediaFileOperation] instance that will create the resource
              def self.media_file(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.media_file(&blk)
                else
                  Factories::V7::Resources.media_file
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::RemarketingAction]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::RemarketingActionOperation] instance that will create the resource
              def self.remarketing_action(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.remarketing_action(&blk)
                else
                  Factories::V7::Resources.remarketing_action
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::UserList]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::UserListOperation] instance that will create the resource
              def self.user_list(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.user_list(&blk)
                else
                  Factories::V7::Resources.user_list
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::BatchJob]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::BatchJobOperation] instance that will create the resource
              def self.batch_job(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.batch_job(&blk)
                else
                  Factories::V7::Resources.batch_job
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Common::UserData]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::OfflineUserDataJobOperation] instance that will create the resource
              def self.offline_user_data_job(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.user_data(&blk)
                else
                  Factories::V7::Resources.user_data
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CustomInterest]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CustomInterestOperation] instance that will create the resource
              def self.custom_interest(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.custom_interest(&blk)
                else
                  Factories::V7::Resources.custom_interest
                end
              ...
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::UserDataOperation] instance that will create the resource
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CustomerClientLink]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CustomerClientLinkOperation] instance that will create the resource
              def self.customer_client_link(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.customer_client_link(&blk)
                else
                  Factories::V7::Resources.customer_client_link
                end
              ...
              #   creates an operation instance, with the resource to be created
              #   set to the passed value (res)
              #   @param res [Google::Ads::GoogleAds::V7::Resources::CustomAudience]
              #     a resource instance to be used for creation in this operation.
              #
              # @return [Google::Ads::GoogleAds::V7::Services::CustomAudienceOperation] instance that will create the resource
              def self.custom_audience(res = nil, &blk)
                ...
                op["create"] = if !res.nil?
                  ...
                  Factories::V7::Resources.custom_audience(&blk)
                else
                  Factories::V7::Resources.custom_audience
                end
            ...
            module UpdateResource
              ...
              #   @param path [String] a resource path for the resource to update
              #   @yield [Google::Ads::GoogleAds::V7::Resources::AccountLink] a new instance of the resource for this update operation, on
              #     which fields can be set to update
              #
              # @overload #account_link(resource, &blk)
              #   @param resource [Google::Ads::GoogleAds::V7::Resources::AccountLink] a resource instance to update
              #   @yield the passed block is called and updates against `resource` are recordered in the update mask
              # @return [Google::Ads::GoogleAds::V7::Services::AccountLinkOperation] the operation instance to update the resource
              def self.account_link(resource_or_path, &blk)
                require "google/ads/google_ads/v7/services/account_link_service_pb"
                res = case resource_or_path
                when Google::Ads::GoogleAds::V7::Resources::AccountLink
                  resource_or_path
                # got a resource path
                when String
                  obj = Google::Ads::GoogleAds::V7::Resources::AccountLink.new
                  obj.resource_name = resource_or_path
                  obj
                else
                  unless Google::Ads::GoogleAds::V7::Resources::AccountLink === res
                    raise ArgumentError.new(
                      "Called #{__method__} with instance of wrong type:"\
                      " #{res.class} want #{operation.update_class}"\
                      " or String representing resource name"
              ...
              #   @param path [String] a resource path for the resource to update
              #   @yield [Google::Ads::GoogleAds::V7::Resources::MerchantCenterLink] a new instance of the resource for this update operation, on
              #     which fields can be set to update
              #
              # @overload #merchant_center_link(resource, &blk)
              #   @param resource [Google::Ads::GoogleAds::V7::Resources::MerchantCenterLink] a resource instance to update
              #   @yield the passed block is called and updates against `resource` are recordered in the update mask
              # @return [Google::Ads::GoogleAds::V7::Services::MerchantCenterLinkOperation] the operation instance to update the resource
              def self.merchant_center_link(resource_or_path, &blk)
                require "google/ads/google_ads/v7/services/merchant_center_link_service_pb"
                res = case resource_or_path
                when Google::Ads::GoogleAds::V7::Resources::MerchantCenterLink
                  resource_or_path
                # got a resource path
                when String
                  obj = Google::Ads::GoogleAds::V7::Resources::MerchantCenterLink.new
                  obj.resource_name = resource_or_path
                  obj
                else
                  unless Google::Ads::GoogleAds::V7::Resources::MerchantCenterLink === res
                    raise ArgumentError.new(
                      "Called #{__method__} with instance of wrong type:"\
                      " #{res.class} want #{operation.update_class}"\
                      " or String representing resource name"
              ...
              #   @param path [String] a resource path for the resource to update
              #   @yield [Google::Ads::GoogleAds::V7::Resources::CustomerManagerLink] a new instance of the resource for this update operation, on
              #     which fields can be set to update
              #
              # @overload #customer_manager_link(resource, &blk)
              #   @param resource [Google::Ads::GoogleAds::V7::Resources::CustomerManagerLink] a resource instance to update
              #   @yield the passed block is called and updates against `resource` are recordered in the update mask
              # @return [Google::Ads::GoogleAds::V7::Services::CustomerManagerLinkOperation] the operation instance to update the resource
              def self.customer_manager_link(resource_or_path, &blk)
                require "google/ads/google_ads/v7/services/customer_manager_link_service_pb"
                res = case resource_or_path
                when Google::Ads::GoogleAds::V7::Resources::CustomerManagerLink
                  resource_or_path
                # got a resource path
                when String
                  obj = Google::Ads::GoogleAds::V7::Resources::CustomerManagerLink.new
                  obj.resource_name = resource_or_path
                  obj
                else
                  unless Google::Ads::GoogleAds::V7::Resources::CustomerManagerLink === res
                    raise ArgumentError.new(
                      "Called #{__method__} with instance of wrong type:"\
                      " #{res.class} want #{operation.update_class}"\
                      " or String representing resource name"
              ...
              #   @param path [String] a resource path for the resource to update
              #   @yield [Google::Ads::GoogleAds::V7::Resources::CustomerClientLink] a new instance of the resource for this update operation, on
              #     which fields can be set to update
              #
              # @overload #customer_client_link(resource, &blk)
              #   @param resource [Google::Ads::GoogleAds::V7::Resources::CustomerClientLink] a resource instance to update
              #   @yield the passed block is called and updates against `resource` are recordered in the update mask
              # @return [Google::Ads::GoogleAds::V7::Services::CustomerClientLinkOperation] the operation instance to update the resource
              def self.customer_client_link(resource_or_path, &blk)
                require "google/ads/google_ads/v7/services/customer_client_link_service_pb"
                res = case resource_or_path
                when Google::Ads::GoogleAds::V7::Resources::CustomerClientLink
                  resource_or_path
                # got a resource path
                when String
                  obj = Google::Ads::GoogleAds::V7::Resources::CustomerClientLink.new
                  obj.resource_name = resource_or_path
                  obj
                else
                  unless Google::Ads::GoogleAds::V7::Resources::CustomerClientLink === res
                    raise ArgumentError.new(
                      "Called #{__method__} with instance of wrong type:"\
                      " #{res.class} want #{operation.update_class}"\
                      " or String representing resource name"
